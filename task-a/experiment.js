    ...
    return (
      "<div class = cct-box>" +
        "<div class = titleBigBox>" +
          ...
          "<div class = titleboxLeft1><div class = center-text id = loss_amount>Loss Amount: " + lossAmt + "</div></div>" +
          "<div class = titleboxMiddle1><div class = center-text id = gain_amount>Gain Amount: " + gainAmt + "</div></div>" +
          "<div class = titlebox><div class = center-text>How many cards do you want to take? </div></div>" +
          "<div class = titleboxRight1><div class = center-text id = num_loss_cards>Number of Loss Cards: " + numLossCards + "</div></div>" +
